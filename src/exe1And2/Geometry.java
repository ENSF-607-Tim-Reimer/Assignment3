...
public class Geometry {
    ...
    public static void main(String[] args) {
        ...
        //      FOR EXERCISE 2
        /*
         exe1And2.Geometry demo = new exe1And2.Geometry();
         System.out.println("\nAdding exe1And2.Rectangle, exe1And2.Circle, and exe1And2.Prism objects to the list... ");
         demo.add(r1);
         demo.add(r2);
         demo.add(c1);
         demo.add(c2);
         ...
         Iterator <exe1And2.Shape> it = demo.shapes.iterator();
         while(it.hasNext()){
